...
def usuario(db, django_user_model):
    ...
    usuario_modelo.save()
    usuario_modelo.senha_plana = senha  # no teste é uma licença poetica válida
...
@pytest.fixture
def resp_home_usuario_logado(client_com_usuario_logado, db):
...
def test_nome_usuario_disponivel(resp_home_usuario_logado, usuario_logado):
    assert_contains(resp_home_usuario_logado, usuario_logado.first_name)


def test_link_de_logout_disponivel(resp_home_usuario_logado):
